            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="container">
                        ...
                        <a href="{{route('cart.addItem',$print->id)}}" style="border-radius: 60px; padding: 7px 18px;" class="m-t-10 waves-effect waves-dark btn btn-primary btn-md btn-rounded">Add to Cart</a><br><br>
                        <!-- <p class="text-left subheader"><small>* Designed by <a href="https://www.carmeltechnologies.co.ke">Maurice</a></small></p> -->
