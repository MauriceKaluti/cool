                ...
                <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
                    ...
                    <div class="block2">
                        ...
                        <div class="block2-txt flex-w flex-t p-t-14">
                            ...
                            $wishData = DB::table('wishlist')->leftJoin('products','wishlist.pro_id','=','products.id')->where('wishlist.pro_id','=',$print->id)->get();

                            $count = App\wishList::where(['pro_id' => $print->id])->count();
                            ...
                            <div class="block2-txt-child2 flex-r p-t-3">
                                ...
                                <input type="hidden" value="{{$print->id}}" name="pro_id">
